 ...
 */
@Component
class DeliveryOrderProvider3Processor(
    private val deliveryOrderRepository: DeliveryOrderRepository,
    private val jooq: JooqWrapper,
    private val eventSender: EventSender
): EventProcessor<DeliveryOrderRoutedEvent> {

    private val logger = LoggerFactory.getLogger(DeliveryOrderProvider3Processor::class.java)

    override fun isApplicable(routingKey: String) = routingKey == RoutingKeys.DELIVERY_ORDER_ROUTED_PROVIDER_3

    override suspend fun process(event: DeliveryOrderRoutedEvent) {
        logger.info("Order '${event.orderId}' has been received by delivery provider 3.")

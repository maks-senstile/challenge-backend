 ...
 */
@Component
class DeliveryOrderProvider1Processor(
    private val deliveryOrderRepository: DeliveryOrderRepository,
    private val jooq: JooqWrapper,
    private val eventSender: EventSender
): EventProcessor<DeliveryOrderRoutedEvent> {

    private val logger = LoggerFactory.getLogger(DeliveryOrderProvider1Processor::class.java)

    override fun isApplicable(routingKey: String) = routingKey == RoutingKeys.DELIVERY_ORDER_ROUTED_PROVIDER_1

    override suspend fun process(event: DeliveryOrderRoutedEvent) {
        logger.info("Order '${event.orderId}' has been received by delivery provider 1.")
